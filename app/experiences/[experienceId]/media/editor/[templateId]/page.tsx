...
import { OpenReelEditorHost } from "./openreel-editor-host";
...
export default async function MediaEditorPage({
	...
	return (
		<div className="flex flex-col gap-4 max-w-[100vw]">
			<div className="flex flex-wrap items-center gap-3 text-3 text-gray-11 px-4 pt-3">
				<Link href={`/experiences/${experienceId}/media`} className="text-gray-12 underline">
					← Back
				</Link>
...
function buildWhopEditorContext(experienceId: string): MediaEditorContext {
	...
	return {
		...
		editorUrlPrefix: `/experiences/${experienceId}/media/editor`,
		backUrl: `/experiences/${experienceId}/media`,
