...
import { ShotstackRenderForm } from "./components/render-form";
import { ShotstackTemplateGalleryClient } from "./components/template-gallery-client";
import type { GalleryTemplate } from "./components/template-gallery";
...
export default async function MediaGalleryPage({
	...
	return (
		<div className="flex flex-col gap-8">
			<div>
				<h2 className="text-6 font-bold text-gray-12">Media Editor</h2>
			...
			<div className="flex flex-wrap gap-4 text-3 text-gray-11 border border-gray-a4 rounded-lg p-4 bg-gray-a2 items-center">
				...
				<Link
					href={`/experiences/${experienceId}/media/billing`}
